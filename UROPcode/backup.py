...
address = 'https://site-search-api.prod.ecommerce.elsevier.com/search?query=' + address + '&labels=journals&start=0&limit=10&lang=en-xs'
######################################################################################
...
'''
Test 1
It takes 403.996169090271 seconds to extract 103 paper abstracts with corresponding titles
from 5 journals and store the abstracts as values and their titles as keys into a dictionary.
'''

'''
Test 2
It takes 771.6567811965942 seconds to extract 215 paper abstracts with corresponding titles
